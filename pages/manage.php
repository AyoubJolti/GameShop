...
<?php include_once "../DBMethodes/gestion_article.php";?>
...
<script src="http://malsup.github.com/jquery.form.js"></script>
 ...
 ?>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
					<?php
						$r=gestion_article::selection_data_BY_VendeurId($_SESSION['iduser']);
						...
						?>
						<h2>Gérez <b>vos jeux </b><b>: <?=$name;?></b></h2>
					</div>
					<div class="col-sm-6">
                ...
                <tbody>
                        ...
                        { 
                           ...
                           <tr>
                               ...
                               <td><?=$row['prix']; ?></td>
                               <td><img src="<?='../images_uplouad/'.$row['image_url']?>" alt="" srcset="" width="80px" height="80px"></td>
                               <td><a href="../modals/ges_art.php?opes=del&id=<?=$row['idart'];?>">Delete</a></td>
                               <td><a href="Edot">Edit</a></td>
	...
	<div id="addGameModal" class="modal fade" style="margin-top: 5%;">
		<div class="modal-dialog">
            ...
            <!--Debut du form-->
			    ...
			    <form  action="../modals/ges_art.php?opes=add" method="POST" class="ajax" enctype="multipart/form-data">					

	...
	<div class="container">
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*" id="all">
					All Products
				</button>

				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" id="Aventure">
					Aventure
				</button>

				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" id="Horreur">
					Horreur
				</button>

				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" id="Action">
					Action
				</button>

				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" id="RPG">
					RPG
				</button>

				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".watches" id="Sport">
					Sport
				</button>
			</div>
		...
		<div>
			<div class="row isotope-grid" id="catgorie" style="height:auto">
				<?php
				include_once "../DBMethodes/gestion_article.php";
				$article = gestion_article::selection_allE_witoutLimit();
		...
		<div style="margin-top: 300px;">
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="#" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04 mt-5">
					Load More
				</a>
			</div>
		</div>
							...
							<div class="p-t-33">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<?php if (isset($_SESSION['iduser']) != null) {
										?>
